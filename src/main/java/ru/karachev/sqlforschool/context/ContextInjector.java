...
public class ContextInjector {
    ...
    private static final FlowCreator FLOW_CREATOR = new FlowCreator(RANDOM, STUDENT_DAO);
    
    private static final Scanner SCANNER = new Scanner(System.in);
    private static final ViewProvider VIEW_PROVIDER = new ViewProvider(SCANNER);
    private static final Controller CONTROLLER = new Controller(DATA_BASE_GENERATOR, DATA_SOURCE, FLOW_CREATOR,
            FILE_READER, GROUP_DAO, COURSE_DAO, STUDENT_DAO, VIEW_PROVIDER);
